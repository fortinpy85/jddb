...
export function StatsOverview({ stats }: StatsOverviewProps) {
  const statsData = [
    {
      title: "Total Jobs",
      value: <AnimatedCounter end={stats?.total_jobs || 0} duration={1500} delay={0} />,
      icon: Database,
      color: "blue" as const,
    ...
    {
      title: "Completed",
      value: <AnimatedCounter end={stats?.processing_status?.completed || 0} duration={1500} delay={200} />,
      icon: CheckCircle,
    ...
    {
      title: "Need Review",
      value: <AnimatedCounter end={stats?.processing_status?.needs_review || 0} duration={1500} delay={400} />,
      icon: AlertCircle,
    ...
    {
      title: "Processing",
      value: <AnimatedCounter end={(stats?.processing_status?.processing || 0) + (stats?.processing_status?.pending || 0)} duration={1500} delay={600} />,
      icon: Clock,
