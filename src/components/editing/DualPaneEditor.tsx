  ...
  const EditorPane = ({ 
    ...
    <div className="flex-1 flex flex-col bg-white dark:bg-slate-800 rounded-xl shadow-lg overflow-hidden">
      ...
      <div className="p-2 border-t border-slate-200 dark:border-slate-700 flex justify-end items-center gap-2">
        <span className="text-xs text-slate-500 dark:text-slate-400">{content.length} characters</span>
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 bg-slate-50 dark:bg-slate-900 min-h-screen">
      <header className="flex justify-between items-center mb-6">
        <h1 className="text-xl font-bold text-slate-800 dark:text-slate-100">Dual-Pane Editor</h1>
      ...
      <footer className="mt-6 flex justify-between items-center">
        <div className="flex items-center gap-2">
            ...
            <span className="text-sm text-slate-600 dark:text-slate-300">Dictionary</span>
        </div>
        <div className="flex items-center gap-2">
          <Switch 
            id="sync-scroll" 
          ...
          />
          <label htmlFor="sync-scroll" className="text-sm text-slate-600 dark:text-slate-300">Sync Scroll</label>
        </div>
      </footer>
    </div>
  );
