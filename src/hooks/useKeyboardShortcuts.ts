  ...
  const handleKeyDown = useCallback(
    (event: KeyboardEvent) => {
      ...
      for (const shortcut of shortcuts) {
        ...
        const hasRequiredCtrl = requiredModifiers.includes('ctrl') || requiredModifiers.includes('meta');
 ...
 */
export function useJDDBKeyboardShortcuts(handlers: Parameters<typeof createJDDBShortcuts>[0]) {
